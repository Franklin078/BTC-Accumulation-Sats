...
| 15 | 2026-08-30 | Final model confirmed: candidate v5, by recorded decision, on the out-of-development record (hold-out 57.38 against 52.12 and 34.14; three-regime mean 65.50; stability under perturbation), stated as a disclosed deviation from the development-metric closure rule; this supersedes entry 13's adjudication-by-reading before any window it would have read had completed, and the reserved windows revert to a one-time reporting table read with the manuscript (basis in full: output/final_model.json) | Two more development-metric wins had already been shown to buy out-of-development losses; deciding on the record that was never selected on, and saying so plainly, is the defensible close |
